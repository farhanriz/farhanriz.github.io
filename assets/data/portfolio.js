    ...
    projects: [
        {
            ...
            year: 2026,
            description: "A medium article, published on Towards Data Engineering.<br><br><a href='https://medium.com/towards-data-engineering/dry-metadata-on-dbt-documentation-with-doc-blocks-ff62f8f90ae6' target='_blank'>Read the article here</a>",
            details: "",
            tags: {
        ...
        },
        {
            ...
            year: 2025,
            description: "<b>Objectives</b><br>- Create & configure dbt environment, pull data, and query data source.<br>- Create several data model (datamarts) using data build tool (dbt) core versions.<br>- Using several dbt features: data modeling, testing, data model build, etc.<br><br><b>Result</b><br>- Technical code: <a href='https://github.com/farhanriz/westjava_occupation_mart' target='_blank'>View on GitHub</a><br>- Medium writings: <a href='https://medium.com/@rizaldifarhan/learning-dbt-in-7-days-what-to-expect-a38e656a3421' target='_blank'>Read on Medium</a> (published in Data and Beyond)",
            details: "",
            tags: {
        ...
        },
        {
            ...
            year: 2024,
            description: "Try to monitor metrics about sales, and show it through dashboard using Power BI",
        ...
        },
        {
            ...
            year: 2024,
            description: "<b>Output:</b> <a href='https://lookerstudio.google.com/reporting/296be2b9-b121-47fc-abab-21d890137a20' target='_blank'>View dashboard here</a>",
            details: "",
            tags: {
                task: ['Data Visualization'],
        ...
        },
        {
            ...
            year: 2024,
            description: "<b>Objective:</b><br>Responsible to create end-to-end dashboard development, start from ideation, create storyboard, define metrics, define charts, and develop dashboard.<br><br><b>Result:</b><br>[add placeholder image]",
            details: "",
            tags: {
                task: ['Data Visualization'],
                tools: ['SQL', 'Tableau'],
        ...
        },
        {
            ...
            year: 2023,
            description: "<b>Objective:</b><br>Responsible to create end-to-end dashboard development, start from ideation, create storyboard, define metrics, define charts, and develop dashboard.<br><br><b>Result:</b><br><a href='https://dashboard.jabarprov.go.id/id/dashboard-static/kebudayaan-dan-pariwisata' target='_blank'>View dashboard here</a>",
            details: "",
            tags: {
                task: ['Data Visualization'],
                tools: ['Tableau'],
        ...
        },
        {
            ...
            year: 2021,
            description: "<b>Objectives:</b><br>Find out active cases proportion trend in West Java, breakdown by cities.<br><br><b>Tableau Public Dashboard:</b> <a href='https://public.tableau.com/app/profile/muhammad.farhan.rizaldi/viz/1VizProporsiKasusAktif/ProporsiKasusCOVID19' target='_blank'>View dashboard here</a>",
            details: "",
            tags: {
                task: ['Data Visualization'],
                tools: ['Tableau'],
        ...
        },
        {
            ...
            year: 2023,
            description: "<b>Objectives</b><br>DataCo needs to monitor their sales performance and need to deliver products faster.<br><br><b>Data Preparation</b><br>- Load Data<br>- Handling missing value<br>- Unit standarization (spatial, non spatial data)<br><br><b>Result</b><br>- Dashboard: <a href='https://public.tableau.com/app/profile/muhammad.farhan.rizaldi/viz/DataCoDashboard/SalesDash' target='_blank'>View dashboard here</a><br>- Report on Medium: <a href='https://medium.com/@rizaldifarhan/dataco-dashboard-report-dcd282168ccd' target='_blank'>Read the article here</a>",
            details: "",
            tags: {
                task: ['Data Visualization'],
                tools: ['Tableau'],
        ...
        },
        {
            ...
            year: 2022,
            description: "<b>Background</b><br>Sapawarga (https://jabarprov.go.id/sapawarga) is a super app developed by west java government for public service in West Java. With a commitment to seamless integration, Sapawarga is gradually becoming the central hub for all public services in West Java.<br><br>As Sapawarga grows in users, understanding their diverse characteristics is crucial. To achieve this, we plan to conduct cluster analysis, grouping users based on common traits and behaviors. This approach will help us tailor services more effectively to the specific needs of each user cluster.<br><br><b>Objectives</b><br>Understanding diverse characteristics of the sapawarga user.<br><br><b>Data Preparation</b><br>Variables: Age range, education level, type of work, region type<br><br>Data preparation step:<br>- Import data<br>- Join data<br>- Data understanding<br>- Handling missing values<br>- Re-labelling data (based on defined variables category/range)<br><br><b>Result</b><br>- Method: KModes Clustering<br>- Cluster: 3 (based on elbow method & silhoutte analysis)<br>- Users clustered to 3 clusters. Clusters are defined based on the variables used and the results are explained in the confidential deck.",
            details: "",
            tags: {
                task: ['Data Analysis'],
                tools: ['Python', 'SQL'],
        ...
        },
        {
            ...
            year: 2023,
            description: "<b>Objectives</b><br>To find out clusters with several points that have very close locations.<br><br><b>Data Preparation</b><br>- Load Data<br>- Handling missing value<br>- Unit standarization (spatial, non spatial data)<br><br><b>Methods</b><br>DBScan Clustering<br><br><b>Result</b><br>[confidential]",
            details: "",
            tags: {
        ...
        },
        {
            ...
            year: 2021,
            description: "<b>Objectives</b><br>Cleansing spatial data that used for scoring in transmission potential analysis/maps.<br><br><b>Data Preparation</b><br>- Load data (Point of interest spatial data)<br>- Data understanding<br>- Handling missing value<br>- Spatial join to villages, district, and cities boundaries<br>- Aggregate data by villages, district, and cities by POI categories.<br><br><b>Result</b><br>- <a href='https://pikobar.jabarprov.go.id/transmission-potential' target='_blank'>View map here</a><br>- <a href='https://www.youtube.com/watch?v=5PfJMfx_D18' target='_blank'>Watch video here</a>",
            details: "",
            tags: {
                task: ['Data Analysis', 'Spatial Analysis', 'GIS Analysis'],
    ...
    experiences: [
        {
            ...
            points: ["Acted as a data consultant to support decision-making across multiple functions and business units", "Designed, developed, and maintained data models, master data, and outputs such as reports and dashboards", "Prepared, scraped, and developed spatial data, including preprocessing for master data development, analysis, and visualization", "Technology: dbt, SQL, Python, Metabase"]
        },
{
